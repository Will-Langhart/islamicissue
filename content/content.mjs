...
// ============ PART IX ============
parts.push({
  title: "Part IX — Prophecy, Miracle, and Origins: The Affirmative Case",
  intro: [
  ...
  items: [
    {
      title: "Failed and Unfulfilled Prophecies",
      critique: [
    ...
    {
      title: "The Literary Challenge (I‘jaz) and Its Unfalsifiability",
      critique: [
    ...
    {
      title: "The Inheritance Arithmetic (the ‘Awl Problem)",
      critique: [
    ...
    {
      title: "The Night Journey and the Negotiated Prayers",
      critique: [
        "The number of the five daily prayers — the second pillar of Islam — derives not from the Quran but from the ascension narrative (mi‘raj) in the sahih hadith (Sahih al-Bukhari 349; 3887). In it, Allah first decrees fifty prayers a day. Descending, Muhammad meets Moses, who says the community cannot bear fifty and tells him to return and ask for a reduction. Muhammad goes back; Allah lowers the number. This repeats — Moses sending him back again and again — until the obligation is reduced from fifty to five, at which point Moses still urges another return, but Muhammad is ashamed to ask more. Allah then says: “They are five and they are fifty; the word with Me does not change” (Bukhari 7517). The theological problem is internal: an omniscient God set a figure He then revised nine times at human prompting, with Moses — not God — foreseeing the practical impossibility the Almighty had apparently overlooked, and the closing formula “My word does not change” appears precisely after the word has changed.",
      ],
      response: [
...
const bibliography = [
  ...
  "Gabriel Said Reynolds, The Qur'an and the Bible: Text and Commentary (Yale, 2018); on apocryphal and Syriac parallels (Infancy Gospel of Thomas, the Syriac Alexander Legend, the Seven Sleepers).",
  "Abd al-Qahir al-Jurjani, Dala'il al-I'jaz (on Quranic inimitability); Navid Kermani and modern studies of the i'jaz doctrine and the tahaddi challenge.",
  "On inheritance and 'awl: the fara'id literature; IslamQA 131556; classical attribution of 'awl to Umar ibn al-Khattab.",
  "On ritual origins: F.E. Peters, The Hajj (Princeton, 1994); G.R. Hawting, The Idea of Idolatry and the Emergence of Islam (Cambridge, 1999); Black Stone and Kaaba entries in the Encyclopaedia of Islam.",
